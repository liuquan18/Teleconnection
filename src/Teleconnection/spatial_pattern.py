...
def rolling_eof(xarr,nmode = 2,window = 10,fixed_pattern = 'all'):
    """
    do eof analysis on a window of a timeseries.
...
###### high level APIs #################
def season_eof(xarr,nmode=2,window=10, fixed_pattern='all',
...
# window=10,fixed_pattern='all',return_full_eof= False,independent = True,standard=True)
    ...
    eof,index,fra = season_eof(trop.var156,nmode=2,window=10,
